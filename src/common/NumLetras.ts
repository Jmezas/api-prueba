export function enletras(num: number) {
  let dec = '';
  let res = '';
  let entero;
  let decimales;
...
function toText(value: number) {
  ...
  if (value == 0) Num2Text = 'CERO';
    ...
    Num2Text = toText(Math.trunc(value / 10) * 10) + ' Y ' + toText(value % 10);
    ...
    Num2Text =
      toText(Math.trunc(value / 100) * 100) + ' ' + toText(value % 100);
    ...
    if (value - Math.trunc(value / 1000000) * 1000000 > 0)
      Num2Text =
        Num2Text + ' ' + toText(value - Math.trunc(value / 1000000) * 1000000);
  } else if (value == 1000000000000) Num2Text = 'UN BILLON';
  else if (value < 2000000000000)
    Num2Text =
      'UN BILLON ' +
      toText(value - Math.trunc(value / 1000000000000) * 1000000000000);
  else {
